...
The code features smooth motor speed transitions (ramping), a dynamic "eye" display on the LCD, and a logic system to prevent the robot from getting stuck in tight spots. The robot features:  
